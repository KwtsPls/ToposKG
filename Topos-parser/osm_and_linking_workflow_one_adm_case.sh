...
java -jar target/Topos-parser-1.0-SNAPSHOT.jar prepare_for_linking OSM "$osm_dir/${input}/${input,,}_wikidata.nt" "$osm_dir/${input}/${input,,}_admin_1.csv" 6
print_lines "$osm_dir/${input}/${input,,}_admin_1.csv"
java -jar target/Topos-parser-1.0-SNAPSHOT.jar prepare_for_linking OSM "$osm_dir/${input}/${input,,}_wikidata.nt" "$osm_dir/${input}/${input,,}_admin_2.csv" 8
